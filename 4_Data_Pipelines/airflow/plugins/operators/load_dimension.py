...
class LoadDimensionOperator(BaseOperator):
    """
    Operator to load SQL dimension tables in AWS Redshift
    ...
    def execute(self, context):
        ...
        formatted_table_insert_sql = LoadDimensionOperator.table_insert_sql.format(
            table=self.table,
