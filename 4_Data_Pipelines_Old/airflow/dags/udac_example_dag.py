...
tables_loaded = DummyOperator(task_id='Tables_loaded',  dag=dag)

run_songplays_quality_checks = DataQualityOperator(
    task_id='Run_data_quality_checks_for_songplays_fact_table',
    dag=dag,
    redshift_conn_id="redshift",
    table="songplays",
    check_null=False
#     check_null=True,
#     columns=["playid","start_time"]
)

run_songs_quality_checks = DataQualityOperator(
    task_id='Run_data_quality_checks_for_songs_dim_table',
    dag=dag,
    redshift_conn_id="redshift",
    table="songs",
    check_null=False
...
run_users_quality_checks = DataQualityOperator(
    task_id='Run_data_quality_checks_for_users_dim_table',
    dag=dag,
    redshift_conn_id="redshift",
    table="users",
    check_null=False
...
run_artists_quality_checks = DataQualityOperator(
    task_id='Run_data_quality_checks_for_artists_dim_table',
    dag=dag,
    redshift_conn_id="redshift",
    table="artists",
    check_null=False
...
run_time_quality_checks = DataQualityOperator(
    task_id='Run_data_quality_checks_for_time_dim_table',
    dag=dag,
    redshift_conn_id="redshift",
    table="time",
    check_null=False
...
run_songplays_quality_checks >> load_songs_dimension_table
run_songplays_quality_checks >> load_users_dimension_table
run_songplays_quality_checks >> load_artists_dimension_table
run_songplays_quality_checks >> load_time_dimension_table

load_songs_dimension_table >> tables_loaded
load_users_dimension_table >> tables_loaded
load_artists_dimension_table >> tables_loaded
load_time_dimension_table >> tables_loaded

tables_loaded >> run_songs_quality_checks
tables_loaded >> run_users_quality_checks
tables_loaded >> run_artists_quality_checks
tables_loaded >> run_time_quality_checks

run_songs_quality_checks >> end_operator
run_users_quality_checks >> end_operator
run_artists_quality_checks >> end_operator
