...
# lifetime_rides_task and city_station_count_task do not appear in
# the ordering of the DAG b/c they are independent of create_oldest_task
# and create_youngest_task